...
HYPERPARAMS = {
    'Tennis': {
        ...
        'noise_amplitude_decay': 0.9939,            # factor for decreasing noise_amplitude
        ...
        'actor_thau':           0.043,              # for soft update of target parameters
        ...
        'critic_thau':          0.043,              # for soft update of target parameters
